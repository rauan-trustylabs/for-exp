    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fees_in_usa', models.PositiveSmallIntegerField(default=0, help_text='указывать сумму в долларах', verbose_name='Сборы фильма')),
                ('url', models.SlugField(max_length=150, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to='movies_shots/', verbose_name='Картинка')),
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movies.Movie', verbose_name='Фильм')),
            ],
            options={
