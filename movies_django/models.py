...
class Genre(models.Model):
    name = models.CharField("Имя режиссера", max_length=100)
    description = models.TextField("Описание")
...
class Movie(models.Model):
    ...
    fees_in_usa = models.PositiveSmallIntegerField("Сборы фильма", default=0,
                                                   help_text="указывать сумму в долларах")
...
class MovieShots(models.Model):
    ...
    image = models.ImageField("Картинка", upload_to='movies_shots/')
